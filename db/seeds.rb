...
Experience.create!(name: 'Les meilleurs Escapes Games',
  ...
  partner_description: "HintHunt vous propose de vivre une aventure unique et hors du commun. Enfermés dans une salle avec votre équipe, vous avez 60 minutes pour trouver le moyen de vous échapper ! A vous de trouver les indices cachés dans la salle et de résoudre ensemble les énigmes qui vous permettront de vous évader ! Une expérience inoubliable dans laquelle rapidité, logique, et esprit d'équipe seront vos meilleurs alliés.",
...
Experience.create!(name: 'Une expérience de Réalité Virtuelle',
  ...
  partner_description: "Incarna est une expérience à part qui vous plongera en plein coeur d'un univers onirique dont vous et vos amis êtes les héros! Equipés de notre matériel de réalité virtuelle, vous serez alors projetés dans une dimension étrange et mystérieuse préparée tout spécialement pour évaluer vos compétences et déterminer si vous avez ce qu'il faut pour devenir un explorateur! Ce baptême du feu ne sera pas de tout repos, mais il ne sera que la première étape d'une aventure épique riche en rebondissements. Chaque nouvel épisode d'Incarna vous entraînera plus profondément dans son univers, à la découverte de ses étranges habitants, de son étonnante histoire et de ses troublants mystères...",
...
Experience.create!(name: "Un séjour inoubliable",
  ...
  partner_description: "Bénéficiez d'une réduction de 15\% sur votre prochain voyage Evaneos supérieur à 500€.",
  category: voyages,
...
Experience.create!(name: "Adoptez un corail",
  ...
  partner_description: "Chaque geste compte. En adoptant un corail, vous contribuez à la préservation de l’environnement et vous soutenez les populations locales qui dépendent de l’océan pour survivre. C’est simple, facile, et utile 🐬",
...
Experience.create!(name: "Offrez un arbre",
  ...
  category: nature,
  partner_description: "Obtenez 3 Chênes sessiles. En achetant des arbres, vous devenez propriétaire d’un actif forestier. L’arbre, en grandissant, est un bien qui prend intrinsèquement de la valeur avec le temps indépendamment de la demande ou du cours du bois 🌳",
...
#Sport
Experience.create!(name: "Un mois d'abonnement à la salle de sport",
  price: '14.99',
  public_price: '19.99',
  validity_date: '2019-12-31',
